...
function List() {
    ...
    const columns = useMemo(
      () => [
        ...
        { header: "Strength For", accessorKey: "strength_for" },
        { header: "Active", accessorKey: "active" },
        {
          ...
          cell: ({ row }) => (
            <div style={{ textAlign: "center" }}>
              <button type="button" className="btn btn-outline-light m-1"><Link to={`/strengths/strength-update/${row.original._id}`} className="card-link m-2">Edit</Link></button>
