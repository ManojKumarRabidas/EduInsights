    ...
    event.preventDefault();
      ...
      <div className="col mb-3">
        ...
        <div className="col mb-3">
          ...
          <input name="teacher_name" type="text" disabled className="form-control" aria-describedby="emailHelp" value={teacher_name} onChange={(e) => setTeacherName(e.target.value)}/>
        </div>
        <div className=" col mb-3">
      <label className="form-label">
